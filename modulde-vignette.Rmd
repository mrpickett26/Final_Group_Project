...
Therefore, this new way of organizing the data will allow us to reduce complexity (dimentionality) without loosing much information.
...
By using the selected fature vector we can finally reorient the data using the axes from the principal components.
